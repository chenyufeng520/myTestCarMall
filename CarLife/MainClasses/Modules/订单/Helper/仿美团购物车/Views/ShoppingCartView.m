...
-(void)layoutUI{
    ...
    self.line = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, 0.5)];
    ...
    [self.shoppingCartBtn setBackgroundImage:[UIImage imageNamed:@"shoppingCari"] forState:UIControlStateNormal];
    self.shoppingCartBtn.frame = CGRectMake(10, -15, 50,50);
    ...
    //小圆点
    self.badge = [[BadgeView alloc] initWithFrame:CGRectMake(self.shoppingCartBtn.frame.size.width - 18, 2, 18, 18) withString:nil];
    ...
    self.OverlayView = [[OverlayView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, kScreen_Height-50)];
