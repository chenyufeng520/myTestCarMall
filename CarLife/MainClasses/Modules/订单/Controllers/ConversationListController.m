...
- (void)viewDidLoad {
    ...
    self.tableView.frame = CGRectMake(0, self.iosChangeFloat+kNavHeight, self.view.frame.size.width, self.view.frame.size.height-kNavHeight-self.iosChangeFloat);
